...
osThreadId HCSR_kontrolHandle;
osThreadId servo_kontrolHandle;
...
/* USER CODE BEGIN Header_StartTaskHCSR_kontrol */
/**
* @brief Function implementing the HCSR_kontrol thread.
* @param argument: Not used
* @retval None
*/
...
void StartTaskHCSR_kontrol(void const * argument)
{
  ...
  /* USER CODE END StartTaskHCSR_kontrol */
}

/* USER CODE BEGIN Header_Startservo_kontol */
/**
* @brief Function implementing the servo_kontrol thread.
* @param argument: Not used
* @retval None
*/
...
void Startservo_kontol(void const * argument)
{
  ...
  /* USER CODE END Startservo_kontol */
}
